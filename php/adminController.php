...
if(isset($_GET["p"]) && $_GET["p"]=="info-teacher") {
    require_once "view\\teachersInformation.php";
}

if(isset($_GET["p"]) && $_GET["p"]=="info-student") {
    require_once "view\\studentsInformation.php";
}
